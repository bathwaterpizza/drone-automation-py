...
if __name__ == "__main__":
    ...
    conf_experiment_high = 10
    conf_experiment_distance = 2
    conf_experiment_heading = 20  # direção do voo.... de 0 a 360 graus pensando no equador e em greenwich 
    ...
    print("Asking takeoff to N meters...")
    copter.user_takeoff(conf_experiment_high)

    print("Waiting to reach at least 15m...")
    copter.wait_altitude((conf_experiment_high -2), (conf_experiment_high + 2), True, timeout=60)
    ...
    delay_to_movement = (conf_experiment_distance // conf_experiment_speed) + 3
